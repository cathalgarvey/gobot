...
import "github.com/hybridgroup/gobot/platforms/bebop/bbtelem"
...
func (t testDrone) Telemetry() chan bbtelem.TelemetryPacket { return nil }
func (t testDrone) StopTelemetry() error                    { return nil }
